...
func (api *API) Shipment(id string) (*Shipment, error) {
	endpoint := fmt.Sprintf("/shipments/%s", id)
...
func (api *API) NewShipment() *Shipment {
	return &Shipment{api: api}
}

func (obj *Shipment) Save() error {
	endpoint := "shipments"
